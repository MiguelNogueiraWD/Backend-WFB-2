...
Route::middleware('auth:chauffeur')->group(function () {
    Route::prefix('chauffeur/profile')->group(function () {
        Route::get('/', function () {
        ...
        Route::get('/chauffeur/missions', [MissionController::class, 'chauffeurIndex'])->name('chauffeur.missions.index');
        Route::get('/chauffeur/missions/{mission}', [MissionController::class, 'show'])->name('chauffeur.missions.show');
    });
